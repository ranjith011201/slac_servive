...
class ReceiverWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ByCategory() async {
      await postsProvider.loadPostsByCategory(categoryName: 'Request');
      print('fhsrthsrhdrth');
    }
    ...
    return ListView.builder(
        itemCount: postsProvider.postsByRequest.length,
        itemBuilder: (ctx, i) {
          print(postsProvider.postsByRequest.length);
          return Container(
              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 6),
                        Text(
                          postsProvider.postsByRequest[i].name,
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 16,
                ...
                AspectRatio(
                  ...
                  child: Container(
                    ...
                    child:
                        Image.network(postsProvider.postsByRequest[i].imageUrl),
                  ),
                ),
                SizedBox(height: 4),
                Row(
                  ...
                  children: [
                      ...
                      child: Padding(
                        ...
                        child: DefaultTextStyle.merge(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(postsProvider.posts[i].title,
                                  style: TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.bold)),
                              ReadMoreText(
                                postsProvider.postsByRequest[i].description,
                                trimLines: 2,
                    ...
                    GestureDetector(
                      onTap: () {
                        sharePost(
                            text: postsProvider.postsByRequest[i].title,
